...
if ($cdata_status == 'pending') {
    ...
    echo '<span class="account__company-documents-title">مستندات</span>';
    echo '</div>';
    echo '<div class="account__company-documents-content">';
    $formsetting = array(
        'post_id' => $com_id,
        ...
        <input type="hidden" id="acf-field_64e46ad0ed4b1" name="acf[field_64e46ad0ed4b1]" value="draft"/>
        ',
    ...
    jQuery(document).ready(function($) {
        ...
        $('#btnsend').on('click', function() {
            if (!confirm("آیا مطمئن هستید؟ (بعد از تایید اطلاعات این فرم جهت بازبینی و انتشار در سایت برای مدیر ارسال خواهد شد.)")) {
                ...
                event.preventDefault();
                $('#acf-field_64e46ad0ed4b1').val('pending');
                $('form#cform').submit();
            }
        });
    });
